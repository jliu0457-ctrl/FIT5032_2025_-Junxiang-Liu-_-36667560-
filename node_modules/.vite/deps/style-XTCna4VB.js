import { Ma as watch, Ti as onMounted, hi as nextTick, kr as getCurrentInstance, oo as readonly, so as ref } from "./vue.runtime.esm-bundler-knA46Kcp.js";
...
function at(t, e) {
	let o = new Blob([t], { type: "application/csv;charset=utf-8;" });
	window.navigator.msSaveOrOpenBlob ? navigator.msSaveOrOpenBlob(o, e + ".csv") : B$1({
		name: e + ".csv",
...
function D(t, e, o = !0) {
	...
	if (t) {
		...
		} : w$1(t), s = d.height, a = d.width, u = e.offsetHeight, p = e.offsetWidth, f = e.getBoundingClientRect(), g = $$2(), it = k$2(), lt = h$2(), L, N, ot = "top";
		f.top + u + s > lt.height ? (L = f.top + g - s, ot = "bottom", L < 0 && (L = g)) : L = u + f.top + g, f.left + a > lt.width ? N = Math.max(0, f.left + it + p - a) : N = f.left + it, V(t) ? t.style.insetInlineEnd = N + "px" : t.style.insetInlineStart = N + "px", t.style.top = L + "px", t.style.transformOrigin = ot, o && (t.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x$2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l = (i = x$2(/-anchor-gutter$/)) == null ? void 0 : i.value) != null ? l : "");
	}
}
function S$1(t, e) {
...
function I(t, e, o = !0, n = void 0) {
	...
	if (t) {
		let i = t.offsetParent ? {
			width: t.offsetWidth,
			height: t.offsetHeight
		} : w$1(t), l = e.offsetHeight, d = e.getBoundingClientRect(), s = h$2(), a, u, p = n != null ? n : "top";
		if (!n && d.top + l + i.height > s.height ? (a = -1 * i.height, p = "bottom", d.top + a < 0 && (a = -1 * d.top)) : a = l, i.width > s.width ? u = d.left * -1 : d.left + i.width > s.width ? u = (d.left + i.width - s.width) * -1 : u = 0, t.style.top = a + "px", t.style.insetInlineStart = u + "px", t.style.transformOrigin = p, o) {
			let f = (r = x$2(/-anchor-gutter$/)) == null ? void 0 : r.value;
...
function q(e, t) {
	if (e != null && t && t.length) {
		for (let n of t) if (k$1(e, n)) return !0;
	}
	return !1;
}
function i(e, t = !0) {
...
//#endregion
export { _t as $, C$2 as A, Mt as B, ne$1 as C, s$2 as D, s$1 as E, I as F, S$1 as G, P as H, It as I, V as J, Tt as K, J$1 as L, Dt as M, G$1 as N, $t as O, Ht as P, Yt as Q, K$1 as R, m as S, q as T, Q$1 as U, Ot as V, Rt as W, Wt as X, W$1 as Y, Y$2 as Z, g$1 as _, s as a, kt as at, k$1 as b, F$1 as c, v$1 as ct, M as d, f as dt, at as et, W as f, ee as g, c as h, x as i, et as it, D as j, At as k, H as l, vt as lt, a as m, N as n, bt as nt, B as o, pt as ot, X as p, U as q, S as r, c$1 as rt, C$1 as s, tt as st, BaseStyle as t, b$2 as tt, J as u, z$1 as ut, h$1 as v, p as w, l as x, i as y, Lt as z };

//# sourceMappingURL=style-XTCna4VB.js.map